...
What BRIDGE Does
    •    Picture-first navigation. Eight big buttons: Bed, Food, Water, Toilet, Charging, WiFi, Bus, Jobs. Tap one and hear its name out loud.
    •    Voice search. Tap the mic and say "I need somewhere to sleep tonight." BRIDGE figures out what you need and answers with voice and images.
...
Every label is paired with an image and a speaker button
Simple
Max 6 large tap targets per screen, 64px minimum
No barriers
No login, no forms, no typing
Built for real conditions
Offline caching, low data use, battery saver dark mode by default
Community-verified
Thumbs up/down on locations keeps data fresh
Tech Stack
...
Purpose
LLM_API_KEY
Intent parsing for voice search
VISION_API_KEY
Photo reading
DEFAULT_CITY
City used for mock data (default: San Francisco)
Project Structure
bridge/
...
└── README.md
Roadmap
    •    [ ] More languages (Chinese, Vietnamese, Tagalog)
    •    [ ] SMS fallback for users without data
    •    [ ] Partnerships with shelters and food banks for real-time bed and meal availability
    •    [ ] Caseworker view to share saved locations with clients
    •    [ ] Expand beyond the pilot city
